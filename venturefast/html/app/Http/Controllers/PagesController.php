...
class PagesController extends Controller
{
    ...
    public function pay(Request $request)
    {
        ...
        $user = $this->user;
        header('Location: https://api.gdonate.ru/pay?public_key='.\App\Http\Controllers\GameController::GDonateKeyPublic.'&sum='.$amount.'&account='.$user->id.'&desc=Пополнение баланса на VENTUREFAST.RU');
        exit();
    }
}
