...
{
    const BOT_TRADE_LINK = 'https://steamcommunity.com/tradeoffer/new/?partner=86925153&token=PIy4wl0H';
    ...
    const API_KEY = '56dadb0edea9e9810cb9de14'; # Ключ для сайта backpack.tf

    const GDonateKeyPublic = '0f055-699';
    const GDonateKey = '30f055fab25dc36adcce1562905ef5f9';
