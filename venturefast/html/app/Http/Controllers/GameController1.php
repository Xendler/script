...
{
    const BOT_TRADE_LINK = 'https://steamcommunity.com/tradeoffer/new/?partner=332022596&token=QcR7El8j';

    const TICKETS_RATE = 10;
    const MIN_PRICE = 30;                    # Минимальная ставка
    const MAX_ITEMS = 15;                   # Максимальное кол-во предметов в ставке
    const COMMISSION = 10;                   # Комиссия
    const COMMISSION_FOR_FIRST_PLAYER = 7;   # Комиссия для первого игрока сделавшего ставку.
    const COMMISSION_FOR_NICK_PLAYER = 2;   # Скидка для игрока с сайтом в нике.
    const NEXTBET_ON = 1;                   # 0 - выключить автоставку, 1 - включить автоставку.
    ...
    const API_KEY = '56f8c5f38667474371194481'; # Ключ для сайта backpack.tf

    const GDonateKeyPublic = 'f684a-1184';
    const GDonateKey = '05483848a0d7c4f2b737b5758e007335';
