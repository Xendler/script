                ...
                <div class="honest-content">
                    ...
                    <div style="height: 210px;" id="check">
                        <div class="honest-form">
                            <input id="totalbank" style="width: 160px;" type="text" value="@if(!empty($game)) {{ $bankTotal = $game->price * \App\Http\Controllers\GameController::TICKETS_RATE }} @endif" placeholder="Банк в копейках">
                        ...
                        <div id="checkResult" class="honest-check-text">@if(!empty($game)) Хэш соответствует числу раунда и секрету. Победный билет: {{ floor($game->rand_number * $bankTotal = $game->price * \App\Http\Controllers\GameController::TICKETS_RATE) }} @else &nbsp; @endif</div>
                    </div>
